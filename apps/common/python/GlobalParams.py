class GlobalParams(object):
    ...
    MYHOST=os.environ.get('METROMS_MYHOST','raijin')
    ...
    if MYHOST=='metlocal':
        ...
        METROMSDIR=os.environ.get('METROMS_SRCDIR','/short/m68/kaa561/metroms_iceshelf')
        tmpdir=os.environ.get('METROMS_TMPDIR','/short/m68/kaa561/metroms_iceshelf')
        RUNDIR=tmpdir+'/tmproms/run'
    else:
        print 'Environment variable MYHOST not defined (metlocal,vilje,raijin)'
        sys.exit(1)
