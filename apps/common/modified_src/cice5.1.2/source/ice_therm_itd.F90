...
!ocl novrec      !Fujitsu
      ...
      !-----------------------------------------------------------------
	    ...
	    ! Add the fluxes to the freshi and fsalti fields
	    ! so ice formation fluxes are separate from ice melt fluxes.
	    freshi(i,j)      = freshi(i,j)      + dfresh
            fsalti(i,j)      = fsalti(i,j)      + dfsalt
