...
! authors: William H. Lipscomb, LANL
      ...
      use ice_flux, only: frzmlt, sst, Tf, strocnxT, strocnyT, rside, &
          ...
          flat, fswabs, flwout, evap, Tref, Qref, Uref, &
	  fresh, freshi, fsalt, fsalti, fhocn, &
	 ...
	 freshin     , & ! flux of water from ice formation, ice to ocean
         fsaltn      , & ! flux of salt, ice to ocean      (kg/m^2/s)
	 fsaltin     , & ! flux of salt from ice formation, ice to ocean
...
! author: William H. Lipscomb, LANL
      ...
      use ice_exit, only: abort_ice
      use ice_flux, only: fresh, freshi, frain, fpond, frzmlt, frazil, &
          frz_onset, update_ocn_f, fsalt, fsalti, Tf, sss, salinz, fhocn, &
	  faero_ocn, rside, meltl
      use ice_fileunits, only: nu_diag
